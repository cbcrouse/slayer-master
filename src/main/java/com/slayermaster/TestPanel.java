...
/*	static
	{
		ARROW_RIGHT_ICON = new ImageIcon(ImageUtil.loadImageResource(TestPanel.class, "/util/arrow_right.png"));
		GITHUB_ICON = new ImageIcon(ImageUtil.loadImageResource(TestPanel.class, "github_icon.png"));
		DISCORD_ICON = new ImageIcon(ImageUtil.loadImageResource(TestPanel.class, "discord_icon.png"));
		PATREON_ICON = new ImageIcon(ImageUtil.loadImageResource(TestPanel.class, "patreon_icon.png"));
		WIKI_ICON = new ImageIcon(ImageUtil.loadImageResource(TestPanel.class, "wiki_icon.png"));
	}*/
