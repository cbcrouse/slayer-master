...
public class MonsterListCellRenderer extends DefaultListCellRenderer
{
	...
	private final int currentSlayerLevel;
	@Setter
	private int hoveredIndex = -1;

	public MonsterListCellRenderer(Map<String, SlayerAssignment> assignmentDetails, int currentSlayerLevel, ImageManager imageManager, ImageCacheManager imageCacheManager)
	{
